class CreateEngines < ActiveRecord::Migration[5.2]
  def change
    create_table :engines do |t|
      ...
      t.integer :intake_manifold, null: false, default: 0       # with a intake manifold (0:yes, 1:no, 2: yes but broken)
      t.integer :throttle_body, null:false, default: 0          # with a throttle body (0:yes, 1:no, 2: yes but broken)
      t.integer :exhaust_manifold, null:false, default: 0       # with a exhaust manifold (0:yes, 1:no, 2: yes but broken)
      t.integer :ignition_coil, nul:false, default: 0           # with a ignition coil (0:yes, 1:no, 2: yes but broken)
      t.integer :turbo_charger, nul:false, default: 0           # with a turbo charger (0:yes, 1:no, 2: yes but broken)
      t.integer :fly_wheel, null:false, default: 0              # with a fly wheel (0:yes, 1:no, 2: yes but broken)
